#!/usr/bin/env python3
"""
SMS Conductor Database Viewer - GUI v1.1
View, edit, and delete SMS messages from Supabase

Version: 1.1 (Add to Reply Messages)
...
class SMSViewer:
    def __init__(self, root):
        self.root = root
        self.root.title("SMS Conductor - Message Database [v1.1]")
        ...
        title = ttk.Label(header_frame, text="📱 SMS Conductor - Message Database  [BETA RELEASE v1.0]", font=("Arial", 16, "bold"))
    ...
    def _create_all_messages_tab(self):
        ...
        ttk.Button(btn_frame, text="💬 Create Test Conversation", command=self.create_test_conversation).pack(side=tk.LEFT, padx=5)
