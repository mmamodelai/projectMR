#!/usr/bin/env python3
"""
Reschedule the 29 Flavors budtenders who never got messages (AUTO-CONFIRM)
"""
...
print(f"\n[SUCCESS] {len(unsent_ids)} campaigns changed to APR!")

print(f"\n{'='*70}")
print("NEXT STEP:")
print("  Run: python test_campaign_scheduler.py")
print("  This will assign NEW times starting from NOW with proper spacing")
print(f"{'='*70}")
