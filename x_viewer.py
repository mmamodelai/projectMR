#!/usr/bin/env python3
"""
X-Viewer - External Budtender Management System
Part of Conductor SMS System

Usage: python x_viewer.py
"""
...
class DispensaryViewer:
    def __init__(self, root):
        self.root = root
        self.root.title("X-Viewer - External Budtender Management")
    ...
    def _create_ui(self):
        ...
        title = tk.Label(
            title_frame,
            text="X-VIEWER - EXTERNAL BUDTENDER MANAGEMENT",
            font=("Arial", 20, "bold"),
            bg=self.bg_color,
